...
function renderStep1(user){
    var root=ensureModalRoot(),
        titleEl=qs(".safe-modal__title",root),
        bodyEl=qs(".safe-modal__body",root),
        footerEl=qs(".safe-modal__footer",root),
        closeBtn=qs(".safe-modal__close",root),
        backdrop=qs(".safe-modal-backdrop",root);
...
function renderStep3(user){
    var root=ensureModalRoot(),
        ...
        closeBtn=qs(".safe-modal__close",root),
        backdrop=qs(".safe-modal-backdrop",root),
        idStr=String(user.userId||"00000000");
    ...
    footerEl.innerHTML="";
    footerEl.appendChild(Object.assign(document.createElement("button"), {type:"button", className:"btn btn--ghost btn--sm", textContent:"Cancel", onclick:hideModal}));
